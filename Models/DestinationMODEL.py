class Destination:
    def __init__(self, id, destination, emergency_contact, emergency_phone, flight_time, kilometers):
    ...
    def __str__(self):
        ...
        attribute = ["Destination", "Destination ID", "Emergency Contact", "Emergency phone number", "Flight time", "Kilometers"] #Longest string is 23 so spacing is 23
        return ("{:<23s}: {}\n{:<23s}: {}\n{:<23s}: {}\n{:<23s}: {}\n{:<23s}: {}\n{:<23s}: {}".format(attribute[0], self.destination, attribute[1], self.id, attribute[2], self.emergency_contact, attribute[3], self.emergency_phone, attribute[4], self.flight_time. attribute[5], self.kilometers))
