class Destination:
    ...
    def __str__(self):
        ...
        return ("{:<23s}: {}\n{:<23s}: {}\n{:<23s}: {}\n{:<23s}: {}\n{:<23s}: {}\n{:<23s}: {}\n".format(attribute[0], self.destination, attribute[1], self.id, attribute[2], self.emergency_contact, attribute[3], self.emergency_phone, attribute[4], self.flight_time, attribute[5], self.kilometers))
